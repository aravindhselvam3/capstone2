  ...
  return (
    <div>
      <div className="d-flex flex-column flex-shrink-0 bg-body-tertiary" style={{ width: '4.5rem' }}>
        ...
        <Link to="/ZenClass" className="d-block p-3 link-body-emphasis text-decoration-none">
        ...
        <ul className="nav nav-pills nav-flush flex-column mb-auto text-center">
          ...
          <li>
            ...
            <Link to="/ZenClass" className="nav-link py-3 border-bottom rounded-0" data-bs-toggle="tooltip" data-bs-placement="right" title="ZenClass">
          ...
          <li>
            <Link to="/Tasks" className="nav-link py-3 border-bottom rounded-0" data-bs-toggle="tooltip" data-bs-placement="right" title="Tasks">
          ...
          <li>
            <Link to="/Webcode" className="nav-link py-3 border-bottom rounded-0" data-bs-toggle="tooltip" data-bs-placement="right" title="Webcode">
          ...
          <li>
            <Link to="Capstone" className="nav-link py-3 border-bottom rounded-0" data-bs-toggle="tooltip" data-bs-placement="right" title="Capstone">
